...
public class EnableContactless {

	public String enableContactlessInfo(String requestJSON) {
		System.out.println("Request callEnableContactless method = "+requestJSON);
		...
		try {
			...
			String value = (String) requestArgsFromT24.get("Value");
			  ...
			  System.out.println("Enable contactless XML::"+input);
