...
public class CreateAccount {
	...
	public String createAccountInfo(String requestJSON) {
		System.out.println("Request callCreateAccount method = "+requestJSON);
		...
		try {
			...
			String RBS_MemberId = (String) requestArgsFromT24.get("RBS_MemberID");
			...
			String productCode1 = (String) requestArgsFromT24.get("product_code1");
			  ...
			  String input ="<UFXMsg xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  msg_type=\"Application\" scheme=\"WAY4Appl\" direction=\"Rq\" version=\"2.0\">"+
						  "<MsgId>"+msgId+"</MsgId>"+ //201801290007
						  "<Source app=\"OPTXML\"/>"+
						  "<MsgData>"+
						  "<Application>"+
						  ...
						  "<ClientIDT>"+
						   ...
						   "<RBSMemberID>"+RBS_MemberId+"</RBSMemberID>"+
						   "</ContractIDT>"+
						   "<Product>"+
			  ...
			  System.out.println("Create account Card XML::"+ input);
