 ...
 *
 */
public class ClearOnlinePin {

	public String clearOnlinePinInfo(String requestJSON) {
		System.out.println("Request callClearOnlinePin method = "+requestJSON);
		...
		try {
			...
			String clearPin = (String) requestArgsFromT24.get("clear_pin");
			  ...
			  String input ="<UFXMsg xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  msg_type=\"Application\" scheme=\"WAY4Appl\" direction=\"Rq\" version=\"2.0\">"+
						"<MsgId>"+msgId+"</MsgId>"+ //201801300001
						"<Source app=\"OPTXML\"/>"+
						"<MsgData>"+
						"<Application>"+
						...
						"<Contract>"+
						"<AddContractInfo>"+
						"<ClearPINAtt>"+clearPin+"</ClearPINAtt>"+
						"</AddContractInfo>"+
						"</Contract>"+
						"</Data>"+
						"</Application>"+
			  ...
			  System.out.println("clear online pin XML::"+input);
