...
public class DisableContactless {

	public String disableContactlessInfo(String requestJSON) {
		System.out.println("Request callDisableContactless method = "+requestJSON);
		...
		try {
			...
			String value = (String) requestArgsFromT24.get("Value");
			  ...
			  System.out.println("Disable contactless XML::"+input);
