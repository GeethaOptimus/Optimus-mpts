...
public class UpdateUsageLimit {

	public String updateUsageLimitInfo(String requestJSON) {
		System.out.println("Request callUpdateUsageLimit method = "+requestJSON);
		...
		try {
			...
			String maxNumber = (String) requestArgsFromT24.get("max_number");
			...
			String shortName = (String) requestArgsFromT24.get("short_name");
			  ...
			  System.out.println("Update usagelimit XML::"+input);
