...
public class ManualEarlierRenew {

	public String manualEarlierRenewInfo(String requestJSON) {
		System.out.println("Request callManualEarlierRenew method = "+requestJSON);
		...
		try {
			...
			String productionType = (String) requestArgsFromT24.get("production_type");			
			String productionEvent = (String) requestArgsFromT24.get("production_event");
			String cardExpiry = (String) requestArgsFromT24.get("card_expiry");
			  ...
			  String input ="<UFXMsg xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  msg_type=\"Application\" scheme=\"WAY4Appl\" direction=\"Rq\" version=\"2.0\">"+
						...
						"<ProductionEvent>"+productionEvent+"</ProductionEvent>"+
			  ...
			  System.out.println("Manual Earlier renew XML::"+input);
