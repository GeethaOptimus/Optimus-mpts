...
public class ChangeCardStatus {
	...
	public String changeCardStatusInfo(String requestJSON) {
		/** 
		 * Not working need to get sample xml data
		*/

		System.out.println("Request callChangeCardStatus method = "+requestJSON);
		...
		try {
			...
			String clientNumber = (String) requestArgsFromT24.get("contract_number");
			String actionCode = (String) requestArgsFromT24.get("action_code");
			String shortName = (String) requestArgsFromT24.get("short_name");
			String comment = (String) requestArgsFromT24.get("comment");
			  ...
			  String input ="<UFXMsg xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  msg_type=\"Application\" scheme=\"WAY4Appl\" direction=\"Rq\" version=\"2.0\">"+
						  ...
						  "<ObjectFor>"+
						  "<ContractIDT>"+
						  "<ContractNumber>"+clientNumber+"</ContractNumber>"+
						  "<Client>"+
						  "<ClientInfo>"+
			  ...
			  System.out.println("change Card status XML::"+input);
