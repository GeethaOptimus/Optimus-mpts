...
public class ClearPINDetails {

	public String clearPINInfo(String requestJSON) {
		
		System.out.println("Request callClearPIN method = "+requestJSON);
		...
		try {
			...
			String paramCode = (String) requestArgsFromT24.get("param_code");
			String value = (String) requestArgsFromT24.get("value");
			String contrNumber = (String) requestArgsFromT24.get("contr_number");
			String clearPin = (String) requestArgsFromT24.get("clear_atm_pin");
			  ...
			  String input ="<UFXMsg xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  msg_type=\"Application\" scheme=\"WAY4Appl\" direction=\"Rq\" version=\"2.0\">"+
						  ...
						  "<ContractIDT>"+
						   ...
						   "<Contract>"+
						   "<AddContractInfo>"+
					   	   "<CLEAR_ATM_PIN>"+clearPin+"</CLEAR_ATM_PIN>"+
						   "</AddContractInfo>"+
						   "</Contract>"+		   
						   "</Data>"+
						   "</Application>"+
			  ...
			  System.out.println("Clear pin details XML::"+input);
